    ...
    return (
        <div className="login">
            ...
            <div className="loginBlock">
                ...
                <Link to={'/login'} className="loginButton"><button className="loginButtonn" onClick={signup}>Создать аккаунт</button></Link>

                <Link to={'/login'} className="loginUnder">Есть аккаунт? Войти</Link>
            </div>
